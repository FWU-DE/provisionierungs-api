...
export type introspection_types = {
    ...
    'Int': unknown;
    'Mutation': { kind: 'OBJECT'; name: 'Mutation'; fields: { 'createClearance': { name: 'createClearance'; type: { kind: 'NON_NULL'; name: never; ofType: { kind: 'OBJECT'; name: 'ClearanceResponse'; ofType: null; }; } }; 'deleteClearance': { name: 'deleteClearance'; type: { kind: 'NON_NULL'; name: never; ofType: { kind: 'OBJECT'; name: 'ClearanceDeleteResponse'; ofType: null; }; } }; }; };
