...
type NullableIndex<
  TObject,
  TProp extends keyof NonNullable<TObject>,
> = null extends TObject
  ? NonNullable<TObject>[TProp] | null
  : NonNullable<TObject>[TProp];

type ResolveRelationsImpl<
...
export type PopulatedRelations<
  TEntity,
  TProps extends keyof TEntity,
> = TEntity & {
...
export type EntityCreateData<
  ...
  TOptionalProps extends keyof TEntity,
> =
