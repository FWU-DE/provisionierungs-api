...
export class Clearance1774430064647 implements MigrationInterface {
  name = 'Clearance1774430064647';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
            CREATE TABLE "school_clearance" (
                ...
                "idm_id" text NOT NULL,
                "school_id" text NOT NULL,
                "school_org_id" text NOT NULL,
                CONSTRAINT "UQ_school_clearance_idm_id_offer_id_school_id_school_org_id" UNIQUE (
                    "offer_id",
                    "idm_id",
                    "school_id",
                    "school_org_id"
